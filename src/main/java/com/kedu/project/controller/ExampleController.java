...
public class ExampleController {
	...
	public void exampleTestPageIcon(){
		
	}
	@RequestMapping(value="/ps", method = RequestMethod.GET)
	public void exampleTestPS(){
		
	}
	@RequestMapping(value="/pt", method = RequestMethod.GET)
	public void exampleTestPT(){
		
	}
	@RequestMapping(value="/pe", method = RequestMethod.GET)
	public void exampleTestPE(){
